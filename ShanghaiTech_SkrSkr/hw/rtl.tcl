...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_ic_ps_e_M_AXI_HPM1_FPD, and set properties
  set axi_ic_ps_e_M_AXI_HPM1_FPD [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_ic_ps_e_M_AXI_HPM1_FPD ]
  ...
  connect_bd_intf_net -intf_net axi_ic_ps_e_M_AXI_HPM1_FPD_M00_AXI [get_bd_intf_pins SkyNet/s_axi_AXILiteS] [get_bd_intf_pins axi_ic_ps_e_M_AXI_HPM1_FPD/M00_AXI]
  connect_bd_intf_net -intf_net ps_e_M_AXI_HPM1_FPD [get_bd_intf_pins axi_ic_ps_e_M_AXI_HPM1_FPD/S00_AXI] [get_bd_intf_pins ps_e/M_AXI_HPM1_FPD]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins ps_e/S_AXI_HP0_FPD] [get_bd_intf_pins smartconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins ps_e/S_AXI_HP1_FPD] [get_bd_intf_pins smartconnect_1/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_2_M00_AXI [get_bd_intf_pins ps_e/S_AXI_HP2_FPD] [get_bd_intf_pins smartconnect_2/M00_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins SkyNet/ap_clk] [get_bd_pins axi_ic_ps_e_M_AXI_HPM1_FPD/ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM1_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM1_FPD/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm1_fpd_aclk] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins ps_e/saxihp1_fpd_aclk] [get_bd_pins ps_e/saxihp2_fpd_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_2/aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_1/dcm_locked]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_ic_ps_e_M_AXI_HPM1_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM1_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM1_FPD/S00_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SkyNet/Data_m_axi_fm] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_LOW] SEG_ps_e_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SkyNet/Data_m_axi_wt] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_LOW] SEG_ps_e_HP1_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SkyNet/Data_m_axi_bm] [get_bd_addr_segs ps_e/SAXIGP4/HP2_DDR_LOW] SEG_ps_e_HP2_DDR_LOW
  create_bd_addr_seg -range 0x00010000 -offset 0xB0000000 [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs SkyNet/s_axi_AXILiteS/Reg] SEG_SkyNet_1_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SkyNet/Data_m_axi_bm] [get_bd_addr_segs ps_e/SAXIGP4/HP2_LPS_OCM] SEG_ps_e_HP2_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs SkyNet/Data_m_axi_bm/SEG_ps_e_HP2_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SkyNet/Data_m_axi_fm] [get_bd_addr_segs ps_e/SAXIGP2/HP0_LPS_OCM] SEG_ps_e_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs SkyNet/Data_m_axi_fm/SEG_ps_e_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SkyNet/Data_m_axi_wt] [get_bd_addr_segs ps_e/SAXIGP3/HP1_LPS_OCM] SEG_ps_e_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs SkyNet/Data_m_axi_wt/SEG_ps_e_HP1_LPS_OCM]
  ...
  set_property PFM_NAME {em.avnet.com:ultra96v2:ultra96v2:1.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {  clk_out1 {id "0" is_default "false" proc_sys_reset "proc_sys_reset_0" }   clk_out2 {id "1" is_default "true"  proc_sys_reset "proc_sys_reset_1" }   clk_out3 {id "2" is_default "false" proc_sys_reset "proc_sys_reset_2" }   } [get_bd_cells /clk_wiz_0]
  set_property PFM.AXI_PORT {M_AXI_HPM1_FPD {memport "M_AXI_GP" sptag "" memory ""} S_AXI_HPC0_FPD {memport "S_AXI_HPC" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S_AXI_HPC1_FPD {memport "S_AXI_HPC" sptag "HPC1" memory "ps_e HPC1_DDR_LOW"} S_AXI_HP0_FPD {memport "S_AXI_HP" sptag "HP0" memory "ps_e HP0_DDR_LOW"} S_AXI_HP1_FPD {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S_AXI_HP2_FPD {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S_AXI_HP3_FPD {memport "S_AXI_HP" sptag "HP3" memory "ps_e HP3_DDR_LOW"}} [get_bd_cells /ps_e]
